...
export function CTAByFooterReadySites() {
    return (
        <div className="container">
            <div className="pt-42">
                ...
                <div className="max-w-3xl mx-auto text-center">
                    <h2 className="text-white text-font-space text-4xl md:text-5xl">Не нашли подходящий сайт?</h2>
                    ...
                    <p className="text-white/50 text-font-inter text-base mt-4">
                        Расскажите, что должно быть на вашем сайте и с чем ему нужно работать. Мы предложим готовое решение, адаптируем существующее или разработаем новое.
                    </p>
                </div>
