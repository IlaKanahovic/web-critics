...
export function CardProductCatalogReadySites(site: CardData) {
    return (
        <div className="group relative rounded-xl bg-[#111111] border border-white/10 shadow-inner shadow-white/5 transition-all duration-300 hover:shadow-2xl hover:border-white/10 overflow-hidden flex flex-col">
            <div className={`w-full h-48 flex items-center justify-center ${site.previewBg || "bg-white/5"} border-b border-white/5`}>
            ...
            <div className="p-5 flex flex-col flex-1">
                ...
                <p className="text-white/60 text-sm mt-1">{site.description}</p>
