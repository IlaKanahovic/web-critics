import { addonItemsReadySites, includedItemsReadySites } from "@/constants/assessment"
import { FaCube, FaPaintBrush, FaRocket, FaPlus, FaCheck } from "react-icons/fa"

export function PriceAssessmentReadySites() {
    return (
                ...
                <div>
                    ...
                    <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-[#111111] border border-white/10 rounded-xl p-6">
                            ...
                            <ul className="space-y-2.5">
                                {addonItemsReadySites.map((item, idx) => (
