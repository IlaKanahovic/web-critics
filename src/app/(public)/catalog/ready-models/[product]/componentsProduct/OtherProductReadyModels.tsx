...
export function OtherProductReadyModels() {
    return (
            ...
            <div className="pt-12">
                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-4xl mx-auto">
                    {[
                        ...
                        { num: "02", title: "Определяем изменения", desc: "Обсуждаем какие задачи должен выполнять инструмент, структуру и дополнительные функции." },
