        ...
        <div className="container">
            <div className="pt-12">
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-[#111111] border border-white/10 rounded-xl p-5 transition-all hover:border-white/20">
                        <h3 className="text-white/50 text-xs uppercase tracking-wider font-medium mb-3">Как работает инструмент</h3>
                        <div className="text-white/80 text-sm font-mono leading-relaxed">
                            <div className="pl-4 space-y-0.5">
                                <div>(как работает инструмент)</div>
                            </div>
                        </div>
                    </div>
                    <div className="bg-[#111111] border border-white/10 rounded-xl p-5 transition-all hover:border-white/20">
