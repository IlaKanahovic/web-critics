...
export function HowWeWorkAutomation() {
    return (
                    ...
                    <div className="lg:col-span-5">
                        <div className="lg:sticky lg:top-32">
                            ...
                            <p className="text-white/55 text-sm md:text-base leading-relaxed mb-6">
                                Нам важно, чтобы после автоматизации сотрудникам стало проще работать, а не пришлось осваивать ещё одну сложную систему.
                            </p>
                            <p className="text-white/55 text-sm md:text-base leading-relaxed mb-10">
                                Поэтому каждое решение строим вокруг существующего процесса и реальных задач людей, которые будут им пользоваться.
                            </p>
