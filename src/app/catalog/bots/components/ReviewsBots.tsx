...
const reviews = [
    {
        ...
        avatar: null,
        rating: 5,
        text: "Заказали готовый бота для уведомлений — всё сделали за 3 дня, адаптировали под наш стиль. Клиенты теперь записываются онлайн, брони больше не теряются. Очень довольны результатом!",
    ...
    },
    {
        ...
        avatar: null,
        rating: 5,
        text: "Бот для бронирования — запустили за 4 дня. Всё работает отлично, бронирование столиков через бота приносит новых гостей. Отдельное спасибо за интеграцию с доставкой.",
        date: "2 сентября 2026",
    }
]

export function ReviewsBots() {
    return (
        <div className="container">
            ...
            <div className="text-center max-w-2xl mx-auto">
                    <h2 className="text-white text-font-space text-4xl md:text-5xl">Что говорят те, кто уже запустил бота</h2>
                    <p className="text-white/60 text-font-inter text-base mt-3">
                        Реальный опыт клиентов, которые автоматизировали часть своих задач с помощью готовых решений.
                    </p>
                </div>
