        ...
        <div className="container">
            <div className="pt-22">
                <div className="mb-4 md:mb-8 flex items-center gap-4">
                    ...
                    <span className="text-white/40 text-xs uppercase tracking-widest">Готовый сайт</span>
                    <div className="h-px flex-1 bg-linear-to-r from-transparent via-white/20 to-transparent" />
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6 md:p-8">
                        <div>
                            ...
                            <div className="flex flex-wrap items-center gap-3 mt-6 text-white/40 text-xs uppercase tracking-wider">
                                <span className="text-white/60">[количество страниц] страниц</span>
                        ...
                        <div>
                            <div className="flex flex-col gap-4">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div className="bg-white/5 border border-white/10 rounded-xl p-4 transition hover:border-white/30">
                                        ...
                                        <Link href={`/catalog/ready-sites/${params.product}/payproduct`}>
                            ...
                            <div className="mt-6 pt-6 border-t border-white/5">
                                <h4 className="text-white/40 text-xs uppercase tracking-wider font-medium">Возможные настройки</h4>
                                <ul className="mt-3 space-y-1.5">
                                    {[
                                        "ВОЗМОЖНЫЕ НАСТРОЙКИ"
                                    ].map((item, idx) => (
